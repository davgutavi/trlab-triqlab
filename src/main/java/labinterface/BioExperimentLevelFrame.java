...
public class BioExperimentLevelFrame extends JFrame {
	...
	private void buildSummaryGraphs() {
		...
		XChartPanel<CategoryChart> p5 = new XChartPanel<CategoryChart>(lc.get(4));
		
		List<BubbleChart> ls = gr.buildSummaryBubbleCharts(solutions);
		XChartPanel<BubbleChart> p10 = new XChartPanel<BubbleChart>(ls.get(0));
		XChartPanel<BubbleChart> p11 = new XChartPanel<BubbleChart>(ls.get(1));
		...
		contentPane.add(p3,"cell 0 2"); contentPane.add(tScroll,"span 2 4,align left");/*contentPane.add(tScroll,"span 1 4");*/
...
//		contentPane.setLayout(new MigLayout("", "[]200[grow, center][grow, center]", "[center][center][center][center][center]"));
